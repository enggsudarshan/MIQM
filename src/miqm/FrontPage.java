...
public class FrontPage extends javax.swing.JFrame {
    ...
    public FrontPage() {
        super("Enter your User name and Password");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(440, 200, 410, 260);

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 36));
        jLabel3.setText("MULTICAMERA IMAGE QUALITY MEASURE SYSTEM");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(210, 90, 1100, 80);
       ...
       String a=jTextField1.getText();
        ...
        ws.setSize(1365, 800);
           ...
           // new FrontPage().setVisible(false);
            //new ProneFrame().setVisible(true);
            //new ProneFrame().setSize(1280,770);
        }

 else
        {
                   FrontIncorrect fi=new FrontIncorrect();
                   fi.setVisible(true);
                   fi.setSize(410, 263);
                   fi.setLocation(445, 230);
 }
